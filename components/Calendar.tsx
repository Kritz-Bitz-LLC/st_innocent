...
const CALENDAR_CONFIG = {
  backgroundImage: "/img/calendar_section_background.webp",
  calendarAddLink:
    "https://calendar.google.com/calendar/u/1?cid=c3Rpbm5vY2VudG9jQGdtYWlsLmNvbQ",
  // Google Calendar API settings
  calendarId: "stinnocentoc@gmail.com",
  apiKey: "AIzaSyCaHe-kexOz7zc4ng8KN1b8T1Jqzagp0Ig",
  // Time window for fetching events (in months)
  monthsBefore: 3, // Fetch events from 3 month before current month
  monthsAfter: 6,  // Fetch events up to 6 months after current month
};
